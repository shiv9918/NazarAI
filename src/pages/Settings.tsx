              ...
              <div className="p-8 md:p-12 space-y-8">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { title: t('settings_page.notifications.issueUpdates'), desc: t('settings_page.notifications.issueUpdatesDesc') },
                      { title: t('settings_page.notifications.newRewards'), desc: t('settings_page.notifications.newRewardsDesc') },
                      { title: t('settings_page.notifications.cityAlerts'), desc: t('settings_page.notifications.cityAlertsDesc') }
                    ].map((item, i) => (
